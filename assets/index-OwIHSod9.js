(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const R="q6wGVb9Aq0qhPo2kRkaUMu7npvf9A2ZE",I="https://app.ticketmaster.com/discovery/v2";async function N(e,n,s,t){try{const o=`${I}/events.json?apikey=${R}&size=${s}&page=${e}&keyword=${n||""}&countryCode=${t}`,r=await fetch(o);if(!r.ok)throw new Error(`Request failed: ${r.status}`);const i=await r.json();if(i?._embedded?.events)return i}catch(o){console.error("error get",o.message)}}const g=document.querySelector(".events-ul"),b=document.querySelector(".dropdown-menu"),x=document.querySelector(".dropdown-toggle"),M=document.querySelector(".pagination-box"),q=document.querySelector("#searching-input"),u=document.querySelector("#modal-vignette"),$=document.querySelector(".loader");function E(e){let n=0;if(n=e,!g)return;g.innerHTML="";const s=n.map((t,o)=>{const r=t.images?.find(w=>w.ratio==="3_2")?.url||"",i=t.dates?.start?.localDate||"No date info",y=t._embedded?.venues?.[0]?.name||"We don't have enough info",f=typeof t.name=="string"&&t.name.trim()!==""?t.name:"Untitled event";return`
    ...
    `}).join("");g.insertAdjacentHTML("beforeend",s)}const D=["US","AD","AI","AR","AU","AT","AZ","BS","BH","BB","BE","BM","BR","BG","CA","CL","CN","CO","CR","HR","CY","CZ","DK","DO","EC","EE","FO","FI","FR","GE","DE","GH","GI","GB","GR","HK","HU","IS","IN","IE","IL","IT","JM","JP","KR","LV","LB","LT","LU","MY","MT","MX","MC","ME","MA","NL","AN","NZ","ND","NO","PE","PL","PT","RO","RU","LC","SA","RS","SG","SK","SI","ZA","ES","SE","CH","TW","TH","TT","TR","UA","AE","UY","VE"];function T(){if(!b)return;b.innerHTML="";const e=D.map(n=>`
      ...
      `).join("");b.insertAdjacentHTML("beforeend",e)}function O(e,n){const s=n.target.closest(".event-item");if(!s)return;const t=e[s.dataset.id],o=t.url||"#",r=t.images?.find(L=>L.ratio==="3_2")?.url||"",i=t.dates?.start?.localDate||"No date info",S=t.dates?.start?.localTime.slice(0,5)||"Unknown time",y=t.dates?.timezone||"Local time",f=t._embedded?.venues?.[0],w=f?.name||"We don't have enough info",B=f?.city?.name||"",k=f?.country?.name||"",A=typeof t.description=="string"&&t.description.trim()!==""?t.description.slice(0,140)+(t.description.length>140?"…":""):!1,P=t._embedded?.attractions?.[0]?.name||"Unknown performer",Z=typeof t.name=="string"&&t.name.trim()!==""?t.name:"Untitled event";u.innerHTML=`<div id="modal-box" class="modal-box">
      ...
      <ul class="modal-info-list" id="modal-info-list">
        <li class="modal-info-item" id="modal-info">
          ...
          <p class="modal-text">${A||Z} </p>
        </li>
        <li
class="modal-info-item" id="modal-when">
          <h2 class="modal-title">When</h2>
          <p class="modal-text">${i}<span class="br-space"></span>${S} (${y})</p>
        </li>
